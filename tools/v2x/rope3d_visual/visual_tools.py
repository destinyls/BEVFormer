...
def parse_option():
    parser = argparse.ArgumentParser('Visualize rope3D dataset', add_help=False)
    parser.add_argument('--root_dir', type=str, default='datasets/Rope3D-KITTI', help='root path to rope3d dataset')
...
class Rope3D():
    ...
    def get_denorm(self, denorm_file):
        print(denorm_file)
    ...
    def __getitem__(self, item):
        ...
        denorm_file = "v2x/rope3d_visual/000021.txt"
...
if __name__ == "__main__":
    args = parse_option()
    dataset = Rope3D(args.root_dir, args.split, args.pred_dir)
