...
train_pipeline = [
    ...
    dict(type='ImageReactify', target_roll=[-5.0, 5.0], pitch_abs=[-3.0, 3.0]),
...
data = dict(
    ...
    train=dict(
        ...
        ann_file=data_root + 'rope3d_infos_temporal_train_het_mini.pkl',
    ...
    val=dict(type=dataset_type,
             ...
             ann_file=data_root + 'rope3d_infos_temporal_val_het_mini.pkl',
